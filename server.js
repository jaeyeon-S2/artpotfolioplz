...
const frontendDistDir = path.join(repoRoot, 'backend', 'dist')
...
const localDbPath = path.join(repoRoot, 'frontend', 'lib', 'local-db.ts')
const runtimePathsPath = path.join(repoRoot, 'frontend', 'lib', 'runtime-paths.ts')
...
const { getUploadsDir } = require(runtimePathsPath)
